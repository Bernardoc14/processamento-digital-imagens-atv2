...
Discente: Bernardo de Carvalho Cavalcante
...
| 4 | `exemplo.png` | Qualquer desenho binário (objeto branco em fundo preto) |
...
5. **`exemplo.png`** (Questão 4) → qualquer desenho binário 80x80 (ou outro
...
7. **Binarize as imagens dos passos 4 a 6** (são todas preto/branco puro; um
   ...
   python binarizar_imagem.py imagens_entrada/exemplo.png
